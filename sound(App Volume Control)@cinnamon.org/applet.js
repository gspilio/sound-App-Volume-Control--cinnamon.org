...
function ImageTextImageMenuItem() {
    this._init.apply(this, arguments);
};

ImageTextImageMenuItem.prototype = {
    __proto__: PopupMenu.PopupBaseMenuItem.prototype,

    _init: function(image, text, icon, align, style) {
...
function PerAppVolumeControl() {
    this._init();
}

PerAppVolumeControl.prototype = {
    __proto__: PopupMenu.PopupBaseMenuItem.prototype,
...
AppControl.prototype = {
    ...
    _volumeToIcon: function(volume) {
        if (volume <= 0) {
            ...
            let n = Math.floor(3 * volume / this.maxVol) + 1;
            if (n < 2)
    ...
    updateMute: function () {
        ...
        slider.setValue(muted ? 0 : this.volume);
...
MyApplet.prototype = {
    ...
    _showFixedElements: function() {
        ...
        this._perAppVolumeControl = new PopupMenu.PopupSubMenuMenuItem(_("App Volume Control"));
        this.menu.addMenuItem(this._perAppVolumeControl);
    ...
    _maybeShowInput: function() {
        ...
        this._perAppVolumeControl.menu.removeAll()
        for ( let i = 0; i < this._apps.length; i++) {
            this._apps[i].destroy();
        }
